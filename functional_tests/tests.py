...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        self.live_server_url = 'http://47.97.248.204'
    ...
    def test_multiple_users_can_start_lists_at_diffrent_urls(self):
        ...
        # Francis visits the home page. There is no sign for Edith's list
        self.browser.get(self.live_server_url)
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        #header_text = self.browser.find_element_by(By,TAG_NAME,'h1').text
